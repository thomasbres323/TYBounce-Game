            ...
            if paddle.pausec !=1:
                ...
                if not ball.bottom_hit:
                    ...
                    if ball.hit==95:
                        ...
                        canvas.create_text(250, 250, text="YOU WON !!", fill="green", font="Consolas 24 ")
                        root.update_idletasks()
                        root.update()
                        playing = False
                        break
                    ...
                    if highscore < str(ball.hit):
                        ...
                        file1.close()
                    canvas.create_text(250, 250, text="GAME OVER!!\n ronaldo's score was: " + str(ball.hit), fill="red", font="Consolas 24 ")
                    root.update_idletasks()
                    root.update()
                    playing = False
                    break
...
canvas.create_text(250, 250, text="Press Enter to start Game!!", fill="red", font="Robus")
root.mainloop()
